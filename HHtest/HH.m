...
ENa = 50; % Nernst potential for Na
EK = -77; % Nernst potential for K
Eleak = -54.4; % Nernst potential for leak current
...
dydt = [((1/Cm)*(I-(INa+IK+Il))); an(V)*(1-n)-bn(V)*n; am(V)*(1-m)-bmm(V)*m; ah(V)*(1-h)-bh(V)*h];
